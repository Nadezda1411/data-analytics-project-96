...
select
    case when visit_date between '2023-06-01' and '2023-06-04' then '1_week'
         ...
         when visit_date between '2023-06-26' and '2023-06-30' then '5_week' end
    as week,
    utm_source,
...
source_and_costs as (
    select
        ...
        dc.daily_spent
    from sessions s
    inner join daily_costs dc
    on s.source = dc.utm_source
